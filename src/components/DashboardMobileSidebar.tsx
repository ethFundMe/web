...
export default function DashboardMobileSidebar({
  ...
  return (
    <div className='fixed bottom-0 left-1/2 z-20 block w-full -translate-x-1/2 bg-primary-default opacity-100 hover:border-slate-200 hover:opacity-100 md:hidden'>
          ...
          <li key={idx} title={route.title}>
            <NavLink
              ...
              activeStyles={({ isActive }) =>
                isActive
                  ? 'bg-primary-default bg-white text-primary-default font-semibold'
                  : 'hover:bg-slate-200 hover:text-primary-default'
              }
